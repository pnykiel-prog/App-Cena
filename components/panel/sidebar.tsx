...
// Buduje listę nawigacji z warunkowymi pozycjami wg planu.
export function buildPanelNav(showAudit: boolean, showLocations: boolean): NavItem[] {
  return [
    ...BASE_NAV,
    ...(showLocations
...
// Desktopowy sidebar (ukryty na mobile — tam działa MobileNav z hamburgerem).
